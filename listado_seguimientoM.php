...
if (!isset($_GET['pg'])){
 ...
 if (mysqli_num_rows($result)>0){
    ...
    if((isset($_GET['clav']) && ($_GET['clav'])!="") || (isset($_POST['btnbuscar']) && $_POST['clavebuscada']!='')){
            echo '<a href="listado_seguimientoM.php"><i class="fa-sharp fa-solid fa-arrow-left fa-2x m-2"></i></a>';}?>
    
        

    <div class="container text-center">
        <div class="text-center mt-5 mb-3"><h3>Listado de Seguimiento de Muebles</h3></div>
        ...
        <table class="table table-striped table-hover">
            ...
            <div class="row">
                <div class="col-4">
                <form action="listado_seguimientoM.php" method="POST">	
...
while ($fila = mysqli_fetch_array($result)) {
    ...
    <tr>
        ...
        <td><?php echo isset($fila["designacion"]) ? $fila["designacion"] : ''; ?></td>
        ...
        <td><?php echo date('d/m/Y', strtotime($fila["fechaing"])); ?></td>
...
for ($i = 0; $i < $itemxpag; $i++) { ?>
    <li class="page-item"><?php echo "<a class='page-link' href='listado_seguimientoM.php?clav=$clavebusqueda&pg=".$i."'>"; echo $i+1;}?></a></li>
 </ul> 
  </div>  

   <?php

     }else header("location:listado_seguimientoM.php?mensaje=noencontrado");
   ?>  
