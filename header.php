    ...
    <!--  -->
        ...
        <ul class="navbar-nav">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a class="dropdown-item" href="listado_seguimientoM.php">Lista de Seguimiento Muebles</a></li>      
            <li><a class="dropdown-item" href="listado_seguimientoL.php">Lista de Seguimiento Libros</a></li>      
          </ul>
            </li>
